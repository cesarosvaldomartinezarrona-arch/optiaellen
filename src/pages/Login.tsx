        ...
        <div className="bg-white rounded-lg shadow-[0_20px_60px_rgba(0,0,0,0.15)] p-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[var(--accent)] hover:bg-[#6b21a8] disabled:opacity-50 text-white font-bold py-4 mt-8 rounded-lg transition-all shadow-lg shadow-[rgba(var(--accent-rgb),0.25)] text-[15px] flex items-center justify-center gap-3"
            >
              {loading ? (
