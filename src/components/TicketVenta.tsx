        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="Nombre, teléfono o ID..." value={searchPatient} onChange={e => setSearchPatient(e.target.value)}
                  className="w-full pl-10 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-700 font-medium outline-none focus:ring-2 focus:ring-[#7c3aed]/20 focus:border-[#7c3aed] transition-all placeholder:text-slate-400" />
              </div>
              {searchPatient && (
          ...
          <Section title="Base / Mica">
            ...
            <div className="mt-4">
              ...
              <select value={data.armazon} onChange={e => update('armazon', e.target.value)}
                className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-700 font-medium outline-none focus:ring-2 focus:ring-[#7c3aed]/20 focus:border-[#7c3aed] transition-all">
          ...
          <Section title="Observaciones">
            <textarea value={data.observaciones} onChange={e => update('observaciones', e.target.value)} rows={2}
              className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-700 outline-none focus:ring-2 focus:ring-[#7c3aed]/20 focus:border-[#7c3aed] resize-none transition-all" />
          </Section>
